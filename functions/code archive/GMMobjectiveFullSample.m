function [J, market_share_sim] = GMMobjectiveFullSample(Params, Model)
% =============================================================================================
...
%% Store normalized guesses in structure
...
%         j = 1
        MarketIndex = j;
        YearIndex = t;
        YearPos = years(YearIndex) == years;
        
        market_share_sim(YearPos,j)=SimulationFullSample(Model,MarketIndex,YearIndex);
    end
end
%% CALCULATE DISTANCE 
