...
load('tempdata/data only 2011/balancedpanel')
...
save ('tempdata\demandEstimation09Feb_v2','Results','Model')

% clear all
% load ('tempdata\demandEstimation09Feb_v2')
% ResultsNew = Results;
% clear Results
% load ('tempdata\demandEstimation09Feb_v1')
% ResultsNew0 = Results;
% clear Results
