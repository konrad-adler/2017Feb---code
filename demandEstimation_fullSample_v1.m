...
Model.MaxFunEvals=60000;             % Optimizaiton Max function evaluations
...
%  tic
%  GMMobjectiveFullSample(InitialParams, Model)
%  toc
%  tic
%  GMMobjectiveFullSample_v1(InitialParams, Model)
%  toc
...
[x,fval,exitflag] = fmincon(@(Params)GMMobjectiveFullSample_v1(Params, Model),InitialParams,[],[],[],[],lb,ub,...
...
save ('tempdata\demandEstimation14Feb','Results','Model')
...
print -dpng -f1 -loose output/demandEstimation14Feb.png
