...
Setup.delta_j = normrnd(2,0.25,nmovies,1); 
Setup.delta_j(1)=1;
Setup.c_j = rand(nmovies,ntaste); %Movie position in taste space
Setup.c_j(1) = 0; % Normalize 1 movie
...
Setup.mu(1)=0; %Normalize 1 market
Setup.mu(2)=1; %Normalize 1 market
Setup.sigma = rand(nmarket,ntaste)*0;
